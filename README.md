...
> `score = 1.70` → equal to ETA on all metrics &nbsp;·&nbsp; **Best checkpoint: ep 2,075 → score `1.2997`** → wait `0.51`, energy `403.7`, cluster `12.2%`
...
> **Best composite checkpoint captured at ep 2,075** → wait = 0.51, score = 1.2997.
...
| Reference at **1.70** = equal to ETA. Best ep 2,075 (score **1.2997**) sits 24% below. | **0.492** — **27% below** ETA and **94.9% below** Nearest Car. |
