...
<sub>🔍 &nbsp;**System Architecture Diagram**</sub>
...
<sub>🔍 &nbsp;**Sequence Diagram** — message flow per time step</sub>
...
<sub>🔍 &nbsp;**Activity Diagram** — complete lifecycle across 4 swim lanes</sub>
...
|:---:|:---:|
| <sub>🔍 **Composite Score**</sub><br/><img src="https://github.com/kumarpiyushraj/multi-elevator-ctde-qrdqn-dispatch/blob/main/Results_Diagrams/Composite_Checkpoint.png?raw=true" alt="Composite Checkpoint Score" width="100%"/> | <sub>🔍 **Avg Wait Time**</sub><br/><img src="https://github.com/kumarpiyushraj/multi-elevator-ctde-qrdqn-dispatch/blob/main/Results_Diagrams/Avg_Wait_Time.png?raw=true" alt="Average Wait Time" width="100%"/> |
...
|:---:|:---:|
| <sub>🔍 **Energy Consumption**</sub><br/><img src="https://github.com/kumarpiyushraj/multi-elevator-ctde-qrdqn-dispatch/blob/main/Results_Diagrams/Energy_Consumption.png?raw=true" alt="Energy Consumption" width="100%"/> | <sub>🔍 **Spatial Distribution**</sub><br/><img src="https://github.com/kumarpiyushraj/multi-elevator-ctde-qrdqn-dispatch/blob/main/Results_Diagrams/Elevator_Spatial_Distribution.png?raw=true" alt="Spatial Distribution" width="100%"/> |
...
|:---:|:---:|
| <sub>🔍 **Stress Test Results**</sub><br/><img src="https://github.com/kumarpiyushraj/multi-elevator-ctde-qrdqn-dispatch/blob/main/Results_Diagrams/Stress_Tests.png?raw=true" alt="Stress Tests" width="100%"/> | <sub>🔍 **Actor Loss**</sub><br/><img src="https://github.com/kumarpiyushraj/multi-elevator-ctde-qrdqn-dispatch/blob/main/Results_Diagrams/Actor_Loss.png?raw=true" alt="Actor Loss" width="100%"/> |
