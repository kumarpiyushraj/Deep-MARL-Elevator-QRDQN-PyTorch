...
> `score = 1.70` → equal to ETA on all metrics &nbsp;·&nbsp; **Best checkpoint: ep 2,725 → score `1.300`** → wait `0.50`, energy `427.6`, cluster `10.0%`
...
| Reference at **1.70** = equal to ETA. Best ep 2,725 (score **1.300**) sits 24% below. | **0.492** — **27% below** ETA and **94.9% below** Nearest Car. |
...
> **Wait** `0.78 → 0.49` · **Energy** `416 → 427` · **Cluster** `52% → 10%` — all improving across 3,500 episodes.
