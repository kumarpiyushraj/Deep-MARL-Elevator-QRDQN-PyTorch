...
> **Best composite checkpoint captured at ep 2,725** → wait = 0.50, energy = 427.6, cluster = 10.0%, score = 1.300.
...
| Reference at **1.60** = equal to ETA. Best ep 2,725 (score **1.300**) sits 19% below. | **0.492** — **27% below** ETA and **94.9% below** Nearest Car. |
...
> Energy consumption bar chart confirms that fewer motor-steps don't come at the cost of higher wait — the RL agent is both faster and more efficient than ETA-Dispatch.

<div align="center">

<sub>📌 &nbsp;**Figure 4 — Energy Consumption**</sub>
...
> **427.2** motor-steps vs ETA's **472.7** — **9.6% fewer** movements. SCAN/LOOK worst at 899.6.

<br/>

---

### 🔬 Figures 5 & 6 — Training Dynamics · Spatial Distribution

> Training dynamics (left) shows all three metrics evolving together across 3,500 episodes. Spatial spread (right) reveals emergent self-organisation: elevators learned to spread without any explicit rule telling them to.

<div align="center">

| <sub>📌 **Figure 5 — Training Dynamics (Wait · Energy · Cluster)**</sub> | <sub>📌 **Figure 6 — Cluster Rate and Spread Index**</sub> |
|:---:|:---:|
| <img src="https://github.com/kumarpiyushraj/multi-elevator-ctde-qrdqn-dispatch/blob/main/Results_Diagrams/Training_Dynamics.png?raw=true" alt="Training Dynamics" width="100%"/> | <img src="https://github.com/kumarpiyushraj/multi-elevator-ctde-qrdqn-dispatch/blob/main/Results_Diagrams/Elevator_Spatial_Distribution.png?raw=true" alt="Spatial Distribution" width="100%"/> |
| **Wait** `0.78 → 0.49` · **Energy** `416 → 427` · **Cluster** `52% → 10%` — all improving across 3,500 episodes. | Spread rises near-zero → **0.306**, exceeding ETA (0.297). Pure reward-driven self-organisation. |
...
| **λ = 0.85** (2.4× training max): wait rises to 2.02 but spread holds. No catastrophic collapse. | **~1.10 → ~0.51** across 3,500 ep with no divergence. Each LR step-down causes a brief expected uptick. |
